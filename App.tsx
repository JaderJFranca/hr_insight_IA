  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-800 mb-2">Gerador de Vagas</h3>
        <p className="text-slate-600">Crie descrições de cargo perfeitas em segundos com ajuda da IA.</p>
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-800 mb-2">Analista de Currículo</h3>
        <p className="text-slate-600">Compare candidatos com suas vagas e descubra os melhores talentos.</p>
      ...
      >
        ...
        <p className="text-slate-600">Gere roteiros de perguntas personalizados para cada candidato.</p>
      ...
      <div className="md:col-span-3 bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-8 text-white relative overflow-hidden mt-8">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-slate-300 mb-6 text-lg">
            Sua central de inteligência para Recursos Humanos. Utilize o poder do Gemini para otimizar seus processos de recrutamento e seleção, desde a criação da vaga até a entrevista final.
          </p>
        </div>
